...
const createAndAppendAddBookButton = parent => {
  ...
  const addBookButton = createButton(text, className, handleAddBookButton);
...
const render = () => {
  ...
  const loadingImage = document.querySelector('.loadingBooks');
...
if (loadingImage.style.display === 'block') {
