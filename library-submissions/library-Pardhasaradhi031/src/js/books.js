...
const showAlert = function () {
  ...
  load.innerText = 'Loading Books....';
  load.className = 'alert-box';
...
const showMessagePopup = function () {
    const books = document.getElementById('books');
    const popUp = document.createElement('div');
    popUp.innerText = 'Cannot perform while loading....';
    popUp.id = 'show-message';
...
const removeListeners = function () {
  ...
  addBookForm.removeEventListener('click', showAddBookForm)
};
...
const addListeners = function () {
  ...
  const addBookForm = document.querySelector('.add-book-button')
  addBookForm.addEventListener('click', showAddBookForm)
}

const addPopUpListeners = function () {
  const select = document.getElementById('group-by');
  const addBookForm = document.querySelector('.add-book-button')
  addBookForm.addEventListener('click', showMessagePopup);
  select.addEventListener('click', showMessagePopup);
};

const removePopUpListeners = function () {
  const select = document.getElementById('group-by');
  const addBookForm = document.querySelector('.add-book-button')
  addBookForm.removeEventListener('click', showMessage);
  select.removeEventListener('click', showMessage);
};
