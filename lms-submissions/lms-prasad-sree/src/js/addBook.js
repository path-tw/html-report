...
const newBooks = () => {
  const books = String.split('\n');
  
}
const newBook = () => {
  const newBook = document.getElementById('popup');
...
const unAvaliableButton = () => {
  const text = document.getElementsByClassName('unAvaliable');
  const section = document.getElementsByClassName('book');
  if (text.innerText === 'Avaliable') {
    text.innerText = 'Not Avaliable';
    text.style.color = 'red';
    section.style.backgroundColor = 'lightblack';
  } else {
    text.innerText = 'Avaliable';
...
const addBook = () => {
  const empty_Div = document.getElementsByClassName('emptyDiv');
  ...
  child.appendChild(genre);
  child.appendChild(year);
  parent.appendChild(child);
  empty_Div.appendChild(parent);
};
...
const genre = () => {
  ...
  newAuthor.appendChild(genreName);
  return newGenre;
};
