'use strict';
const bookDetails = [
  { bookTitle: 'The Lord of the Rings: The Two Towers', year: 1954, genre: 'Fantasy', author: 'J.R.R. Tolkien', coverPage: 'src/images/the lord.png', availability: true },
  { bookTitle: 'The Three Musketeers', year: 1844, genre: 'Adventure', author: 'Alexandre Dumas', coverPage: 'src/images/3muskesters.png', availability: true },
  { bookTitle: 'The Count of Monte Cristo', year: 1844, genre: 'Adventure', author: 'Alexandre Dumas', coverPage: 'src/images/the count.png', availability: true },
  { bookTitle: 'Don Quixote', year: 1605, genre: 'Comedy', author: 'Miguel de Cervantes', coverPage: 'src/images/don.png', availability: true },
  { bookTitle: 'The Lord of the Rings: The Fellowship of the Ring', year: 1954, genre: 'Fantasy', author: 'J.R.R. Tolkien', coverPage: 'src/images/thelord2.png', availability: true },
  { bookTitle: '1984', year: 1949, genre: 'History', author: 'George Orwell', coverPage: 'src/images/1984.png', availability: true },
  { bookTitle: 'Animal Farm', year: 1945, genre: 'History', author: 'George Orwell', coverPage: 'src/images/animal.png', availability: true },
  { bookTitle: 'Treasure Island', year: 1883, genre: 'Adventure', author: 'Robert Louis Stevenson', coverPage: 'src/images/treasure.png', availability: true },
  { bookTitle: 'Harry Potter and the Sorcerers Stone', year: 1997, genre: 'Fantasy', author: 'J.K. Rowling', coverPage: 'src/images/harryPotter1.png', availability: true },
  { bookTitle: 'Harry Potter and the Chamber of Secrets', year: 1998, genre: 'Fantasy', author: 'J.K. Rowling', coverPage: 'src/images/harryPotter2.png', availability: true }
]; // data for books in library

const booksDataCSV = `Name,Published Year,Genre,Author
