const booksData = [
  ...
  "Harry Potter and the Sorcerers Stone,1997,Fantasy,J.K. Rowling",
  ...
  "Gullivers Travels,1726,Adventure,Jonathan Swift",
  "A Tale of Two Cities,1859,History,Charles Dickens",
  "Great Expectations,1861,History,Charles Dickens",
  ...
  "Alices Adventures in Wonderland,1865,Fantasy,Lewis Carroll",
  ...
  "Cats Cradle,1963,Comedy,Kurt Vonnegut",
  ...
  "The Wise Mans Fear,2011,Fantasy,Patrick Rothfuss",
  ...
  "The Time Travelers Wife,2003,Fantasy,Audrey Niffenegger",
  ...
  "The Handmaids Tale,1985,Fantasy,Margaret Atwood",
  "The Girl Who Kicked the Hornets Nest,2007,History,Stieg Larsson",
  ...
  "The Name of the Wind,2007,Fantasy,Patrick Rothfuss",
  " The Wise Mans Fear,2011,FTheantasy,Patrick Rothfuss",
  ...
  "Picture of Dorian Gray,1890,Fantasy,Oscar Wilde",
  ...
  "The Belgariad: Magicians Gambit,1983,Fantasy,David Eddings",
  ...
  "The Farseer Trilogy: Assassins Apprentice,1995,Fantasy,Robin Hobb",
  "The Farseer Trilogy: Royal Assassin,1996,Fantasy,Robin Hobb",
  " The Farseer Trilogy: Assassins Quest,1997,Fantasy,Robin Hobb",
...
let booksRecordObject = convert();

const appendAll = function () {
  const bookData = convert();
...
const displayBooks = function (book){
  ...
  bookNames(book, bookContainer);
  genreCreation(book, bookContainer);
  authorFeild(book, bookContainer);
  year(book, bookContainer);
  availability(bookContainer);
  document.getElementById("bookContainer").append(bookContainer);
};

const bookNames = function (book, bookContainer) {
...
const genreCreation = function (book, bookContainer) {
  const genre = document.createElement("div");
  genre.classList.add("Genre");
  bookContainer.append(genre);
  genre.innerText = "Genre : " + book.genre;
};

const authorFeild = function (book, bookContainer) {
  const author = document.createElement("div");
  author.classList.add("authorName");
  bookContainer.append(author);
  author.innerText = "Author :" + book.author;
};
const year = function (book, bookContainer) {
  const year = document.createElement("div");
  year.classList.add("publishedYear");
  bookContainer.append(year);
  year.innerText = "published Year :" + book.year;
};

const availability = function (bookContainer) {
  const bookAvailability = document.createElement("div");
  bookAvailability.classList.add("availability");
  bookContainer.append(bookAvailability);
  ...
  statusText(bookAvailability ,bookContainer);
};

const statusText = function ( bookAvailability,bookContainer){
  const statusText = document.createElement("div");
  statusText.classList.add("statusText");
  bookContainer.append(statusText);
...
const changeStatusText = function(bookAvailability ,statusText) {
    ...
    bookAvailability.addEventListener('mouseover',function(){
      if (bookAvailability.innerText === "UN-AVAILABLE"){
        statusText.innerText = 'Book is unavailable to lend, pls dbclick to udo the status';
